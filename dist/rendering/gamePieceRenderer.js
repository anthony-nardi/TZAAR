...
class GamePieceRenderer {
    constructor() {
        this.TRIANGLE_SIDE_LENGTH = null;
        this.GAME_PIECE_RADIUS = null;
        this.TRIANGLE_HEIGHT = null;
        this.PLAYER_ONE_TOTT = document.createElement("canvas");
        this.PLAYER_ONE_TZARRA = document.createElement("canvas");
        this.PLAYER_ONE_TZAAR = document.createElement("canvas");
        this.PLAYER_TWO_TOTT = document.createElement("canvas");
        this.PLAYER_TWO_TZARRA = document.createElement("canvas");
        this.PLAYER_TWO_TZAAR = document.createElement("canvas");
        this.circleRadius = null;
        this.smallerCircleRadius = null;
        this.CANVAS_SIDE_LENGTH = null;
        this.CANVAS_STYLE_LENGTH = null;
        this.CENTER_COLOR = "#FDD835";
        this.PLAYER_ONE_COLOR_BG = "#1E88E5";
        this.PLAYER_TWO_COLOR_BG = "#212121";
    }
    init() {
        const extraSpace = 1;
        ...
        this.PLAYER_ONE_TOTT.getContext("2d")?.setTransform(WindowHelper.devicePixelRatio, 0, 0, WindowHelper.devicePixelRatio, 0, 0);
        this.PLAYER_ONE_TZARRA.getContext("2d")?.setTransform(WindowHelper.devicePixelRatio, 0, 0, WindowHelper.devicePixelRatio, 0, 0);
        this.PLAYER_ONE_TZAAR.getContext("2d")?.setTransform(WindowHelper.devicePixelRatio, 0, 0, WindowHelper.devicePixelRatio, 0, 0);
        this.PLAYER_TWO_TOTT.getContext("2d")?.setTransform(WindowHelper.devicePixelRatio, 0, 0, WindowHelper.devicePixelRatio, 0, 0);
        this.PLAYER_TWO_TZARRA.getContext("2d")?.setTransform(WindowHelper.devicePixelRatio, 0, 0, WindowHelper.devicePixelRatio, 0, 0);
        this.PLAYER_TWO_TZAAR.getContext("2d")?.setTransform(WindowHelper.devicePixelRatio, 0, 0, WindowHelper.devicePixelRatio, 0, 0);
        const playerOneTott = {
            type: TOTT,
            ownedBy: PLAYER_ONE,
            stackSize: 1,
    ...
    drawGamePiece(gamePiece, canvas) {
        ...
        if (gamePiece.ownedBy === PLAYER_ONE) {
            ...
            context.drawImage(image, 0, 0, this.circleRadius * 2, this.circleRadius * 2);
            return;
        }
        else {
            if (gamePiece.type === TOTT) {
...
//# sourceMappingURL=gamePieceRenderer.js.map